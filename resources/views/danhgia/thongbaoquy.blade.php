                        ...
                        <table id="table" class="table table-bordered table-striped">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center align-middle" colspan="2">Tháng ...</th>
                                    <th class="text-center align-middle" colspan="2">Tháng ...</th>
                                    <th class="text-center align-middle" colspan="2">Tháng ...</th>
                                    <th class="text-center align-middle" rowspan="2">Kết quả phê duyệt quý</th>
                                    <th class="text-center align-middle" rowspan="2">Ghi chú</th>    
                                    <th class="text-center align-middle" rowspan="2" style="display: none;">Phòng</th>
                                    <th class="text-center align-middle" rowspan="2" style="display: none;">Đơn vị</th>
                                </tr>
                                <tr>
